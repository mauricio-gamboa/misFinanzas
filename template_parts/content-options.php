      ...
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-5">
        <div class="options-text first">
          ...
          <div class="links clearfix">
            <a href="<?php echo ot_get_option('link_solicita_usuario'); ?>" class="my-btn btn-2" target="_blank" ga-solicita-usuario>solicita tu usuario </a>
          </div>
          <?php endif; ?>
        </div>
      </div>
      <div class="col-xs-12 col-sm-6 col-md-offset-1 col-md-5 col-lg-offset-2 col-lg-5">
        <div class="options-text last">
          ...
          <div class="links clearfix">
            ...
            <a href="<?php echo ot_get_option('link_solicita_cuenta'); ?>" class="my-btn btn-3" target="_blank" ga-solicita-cuenta>solicita tu CUENTA</a>
            <?php endif; ?>
            
            <?php if(ot_get_option('link_solicita_tarjeta')): ?>
            <a href="<?php echo ot_get_option('link_solicita_tarjeta'); ?>" class="my-btn btn-3" target="_blank" ga-solicita-tarjeta>solicita tu TARJETA</a>
            <?php endif; ?>
          </div>
        </div>
      </div>
