<section id="small-features" class="site-padding" ng-controller="SecondaryFeaturesController as features" in-view="features.showThem($inview)" in-view-options="{ offsetTop: 200 }">
  <div class="container">
    <div class="row">
